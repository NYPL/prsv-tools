...
def test_accepts_paths(monkeypatch, tmp_path: Path):
    ...
    monkeypatch.setattr(
        "sys.argv",
        ["../bin/flatten_er_metadata_folder.py", "--package", str(child1), str(child2)],
    )
...
def test_accepts_dir_of_packages(monkeypatch, tmp_path: Path):
    ...
    monkeypatch.setattr(
        "sys.argv",
        ["../bin/flatten_er_metadata_folder.py", "--directory", str(tmp_path)],
    )
...
def test_nonexistent_package(monkeypatch, tmp_path: Path, capsys):
    ...
    monkeypatch.setattr(
        "sys.argv", ["../bin/flatten_er_metadata_folder.py", "--package", str(child)]
    )
...
def test_nonexistent_directory(monkeypatch, tmp_path: Path, capsys):
    ...
    monkeypatch.setattr(
        "sys.argv", ["../bin/flatten_er_metadata_folder.py", "--directory", str(child)]
    )
